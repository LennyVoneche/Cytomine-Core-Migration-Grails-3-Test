    ...
    initTableProperty: function () {
        ...
        if (self.nameDomain == "Annotation") {
            ...
            new PropertyCollection({
                domainClassName: "cytomine.core.image.ImageInstance",
            ...
            new PropertyCollection({
                domainClassName: "cytomine.core.project.Project",
            ...
            new PropertyCollection({
                domainClassName: "cytomine.core.processing.Job",
                domainIdent: idDomain
            }).fetch({
                success: function (collection, response) {
        ...
        if ((value != "" && key != "")) {
            if (self.nameDomain == "Annotation") {
                ...
                new PropertyModel({
                    ...
                    key: key,
                    value: value
                }).save({domainClassName: "cytomine.core.project.Project",
