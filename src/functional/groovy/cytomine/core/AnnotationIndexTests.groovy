...
import cytomine.core.test.http.AnnotationDomainAPI
import cytomine.core.test.http.AnnotationIndexAPI
import cytomine.core.test.http.ReviewedAnnotationAPI
