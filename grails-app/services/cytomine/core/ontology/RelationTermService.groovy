...
class RelationTermService extends ModelService {
    ...
    def get(Relation relation, Term term1, Term term2) {
        securityACLService.check(term1.container(), BasePermission.READ)
        securityACLService.check(term2.container(), BasePermission.READ)
     ...
     */
    def add(def json) {
        securityACLService.check(json.term1,Term,"getOntology", BasePermission.WRITE)
        securityACLService.check(json.term2,Term,"getOntology", BasePermission.WRITE)
