...
class SoftwareParameterService extends ModelService {
    ...
    def read(def id) {
        ...
        securityACLService.check(softParam.software, BasePermission.READ)
        softParam
    }
    ...
    def add(def json) throws CytomineException {
        securityACLService.check(json.software, Software, BasePermission.READ)
    ...
    def update(SoftwareParameter softwareParam, def jsonNewData) {
        securityACLService.check(softwareParam.container(), BasePermission.WRITE)
        SecUser currentUser = cytomineService.getCurrentUser()
