...
import cytomine.core.utils.Description
...
class ImageInstanceService extends ModelService {
     ...
     */
    def add(def json) {
        securityACLService.check(json.project,Project, BasePermission.READ)
        ...
        if(alreadyExist && alreadyExist.checkDeleted()) {
            ...
            securityACLService.check(alreadyExist.container(), BasePermission.READ)
    ...
    def update(ImageInstance domain, def jsonNewData) {
        ...
        securityACLService.check(jsonNewData.project,Project, BasePermission.READ)
