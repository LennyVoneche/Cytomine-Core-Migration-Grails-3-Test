...
class AmqpQueueConfigService extends ModelService{
    ...
    def initAmqpQueueConfigDefaultValues() {
        print getClass().getName() + ' initAmqpQueueConfigDefaultValues : ' + '001' + '\n'
        ...
        print getClass().getName() + ' initAmqpQueueConfigDefaultValues : ' + '002' + '\n'
        ...
        print getClass().getName() + ' initAmqpQueueConfigDefaultValues : ' + '003' + '\n'
        ...
        print getClass().getName() + ' initAmqpQueueConfigDefaultValues : ' + '004' + '\n'
        ...
        print getClass().getName() + ' initAmqpQueueConfigDefaultValues : ' + '005' + '\n'
