...
class DescriptionService extends ModelService {
    ...
    def get(def domainIdent, def domainClassName) {
        if (domainClassName.equals("cytomine.core.processing.Software") || domainClassName.equals("cytomine.core.processing.SoftwareParameter")) {
            securityACLService.checkGuest(cytomineService.currentUser)
        }
        else {
            securityACLService.check(domainIdent,domainClassName, BasePermission.READ)
        }
    ...
    def update(Description description, def jsonNewData) {
        securityACLService.check(description.container(), BasePermission.READ)
