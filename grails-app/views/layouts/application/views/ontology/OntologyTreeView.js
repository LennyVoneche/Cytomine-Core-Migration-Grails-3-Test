            ...
            onSelect: function (select, node) {
                ...
                if (node.isSelected()) {
                    if (self.browseImageView.isCurrentAnnotationUser()) {
                        ...
                        if (self.browseImageView.currentAnnotation.get("class") == "cytomine.core.ontology.ReviewedAnnotation") {
...
//    },
    ...
    refresh: function (idAnnotation) {
        ...
        //if(self.browseImageView.currentAnnotation.get("class")=="cytomine.core.ontology.ReviewedAnnotation")  return;
